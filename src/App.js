...
import PlaceholderImage from './pictures/milo.jpg'; 
import AnotherImage from './pictures/otto.jpg';
  ...
  return (
    <div className="App">
      <React.Fragment>
        ...
        <TextField id="textfield1" classname="custom-textfield" background="blue" />
        <TextField id="textfield2" classname="custom-textfield" background="blue" />
